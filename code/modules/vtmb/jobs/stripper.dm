...
/datum/job/vamp/strip
	...
	allowed_bloodlines = list("True Brujah", "Daughters of Cacophony", "Salubri", "Nagaraja", "Salubri Warrior", "Baali", "Brujah", "Tremere", "Ventrue", "Nosferatu", "Gangrel", "Toreador", "Malkavian", "Banu Haqim", "Giovanni", "Ministry", "Tzimisce", "Lasombra", "Caitiff", "Kiasyd")

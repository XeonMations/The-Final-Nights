...
/mob/living/simple_animal/hostile/bear/butter/AttackingTarget(atom/attacked_target) //Makes some attacks by the butter bear slip those who dare cross its path.
	if(isliving(target))

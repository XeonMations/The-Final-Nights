	...
	if(soft)
		...
		switch(soft)
			...
			if("image") // Set pAI card display face
				var/newImage = input("Select your new display image.", "Display Image", "Happy") in sort_list(list("Happy", "Cat", "Extremely Happy", "Face", "Laugh", "Off", "Sad", "Angry", "What", "Sunglasses"))
				switch(newImage)
					if(null)

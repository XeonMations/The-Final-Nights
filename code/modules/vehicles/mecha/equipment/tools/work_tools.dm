...
/obj/item/mecha_parts/mecha_equipment/ripleyupgrade/attach(obj/vehicle/sealed/mecha/markone)
	...
	marktwo.atom_integrity = round((markone.atom_integrity / markone.max_integrity) * marktwo.atom_integrity) //Integ set to the same percentage integ as the old mecha, rounded to be whole number

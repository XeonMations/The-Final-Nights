...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_PROTEAN_VISION" = TRAIT_PROTEAN_VISION,
		...
		"TRAIT_ALT_NIGHT_VISION" = TRAIT_ALT_NIGHT_VISION,
		...
		"TRAIT_DOGWOLF" = TRAIT_DOGWOLF,
		"TRAIT_UNBONDABLE" = TRAIT_UNBONDABLE,
		"TRAIT_UNBONDING" = TRAIT_UNBONDING,
		"TRAIT_DEFICIENT_VITAE" = TRAIT_DEFICIENT_VITAE,
		"TRAIT_SCENTTRUEFORM" = TRAIT_SCENTTRUEFORM,
		...
		"TRAIT_FRENETIC_AURA" = TRAIT_FRENETIC_AURA,
		...
		"TRAIT_CUFFBREAKER" = TRAIT_CUFFBREAKER,
		...
		"TRAIT_NO_REFLECTION" = TRAIT_NO_REFLECTION,

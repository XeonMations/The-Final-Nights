...
/datum/component/storage/Initialize(datum/component/storage/concrete/master)
	...
	RegisterSignal(parent, list(COMSIG_CLICK_ALT, COMSIG_ATOM_ATTACK_HAND_SECONDARY),PROC_REF(on_open_storage_click))
...
/datum/component/storage/proc/update_appearance()
	if(isobj(parent))
		var/obj/O = parent
		O.update_appearance()

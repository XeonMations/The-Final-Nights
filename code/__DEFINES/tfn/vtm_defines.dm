...
#define HIGHEST_GENERATION_LIMIT 15 //Those of the 15th Generation have failed to sire any progeny. Their blood is far too thin, and they are too removed from Caine, to be able to pass on the curse.
...
#define CLAN_THINBLOOD "Thin-blood"
